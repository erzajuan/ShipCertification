...
class FormKontruksiController extends GetxController {
  ...
  TextEditingController controllerPenandaanDapatDilihat1 =
      TextEditingController();
  TextEditingController controllerPenandaanDapatDilihat2 =
      TextEditingController();
  ...
  TextEditingController controllerKondisiKekedapanCuaca1 =
      TextEditingController();
  TextEditingController controllerKondisiKekedapanCuaca2 =
      TextEditingController();
  ...
  TextEditingController controllerIII2 = TextEditingController();
  TextEditingController controllerIII3 = TextEditingController();
